...
<button onclick="toggleAbstract('abstract1')" style="padding: 2px 6px; margin: 2px; font-size: 0.8em; border: 1px solid; border-radius: 4px;">Abstract <span class="arrow">▼</span></button>
